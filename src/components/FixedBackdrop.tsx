  ...
  return (
    ...
    >
      <svg
        ...
        style={{
          filter:
            "drop-shadow(1px 1.5px 1px rgba(0, 0, 0, 0.7)) drop-shadow(-0.5px -0.5px 0.5px rgba(255, 235, 180, 0.35))",
        }}
      >
        <defs>
          ...
          <g id="coffee-berry-pair" fill="none" stroke="url(#gold-foil)" strokeWidth="2" strokeLinecap="round">
